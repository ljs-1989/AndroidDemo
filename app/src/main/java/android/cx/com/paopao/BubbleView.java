...
public class BubbleView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private float curDrawerAlpha = 0f;  //当前透明度 (范围为0f~1f，因为 FloatCircle 中 convertAlphaColor 方法已经处理过了)
    ...
    public BubbleDrawer getCurDrawer() {
        return mCurDrawer;
    }
    ...
    private class DrawThread extends Thread {
        ...
        private void drawSurface(Canvas canvas) {
            ...
            if (mPreDrawer != null && curDrawerAlpha < 1f) {
                ...
                mCurDrawer.drawBgAndBubble(canvas,0.3f);
            }
            ...
            if (mCurDrawer != null) {
                mCurDrawer.setViewSize(mWidth,mHeight);
                mCurDrawer.drawBgAndBubble(canvas,0.8f);
            }
        }
